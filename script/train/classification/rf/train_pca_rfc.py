...
from script.train.classification.rf import train_pca_rfc
...
def main(args: List[str]):
    argv: Namespace = train_pca_rfc.parse_args(args)
    ...
    dataset_config, mel_spec_config, reshape_config, pool_config, pca_config, rfc_config, loader_config = train_pca_rfc.get_config(
        argv=argv)
