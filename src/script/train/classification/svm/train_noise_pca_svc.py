...
def get_config(argv: Namespace):
    ...
    AUGMENT_CONIFG_PATH: str = argv.sound_wave_augment_config_path
    ...
    sound_wave_augment_config: conf_augment.SoundWaveAugmentConfig = conf_augment.get_augment_config_from_json(
        AUGMENT_CONIFG_PATH, conf_augment.SoundWaveAugmentConfig)
    ...
    pool_config: conf_pool.PoolConfig = conf_pool.get_pool_config_from_json(
        POOL_CONFIG_PATH)
    return dataset_config, sound_wave_augment_config, mel_spec_config, reshape_config, pool_config, pca_config, svc_config, loader_config
